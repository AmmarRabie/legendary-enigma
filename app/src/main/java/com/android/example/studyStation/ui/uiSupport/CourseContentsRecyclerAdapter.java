...
public class CourseContentsRecyclerAdapter extends RecyclerView.Adapter<CourseContentsRecyclerAdapter.NewViewHolder> {

    private static final String TAG = CourseContentsRecyclerAdapter.class.getSimpleName();
    ...
    public CourseContentsRecyclerAdapter(Context mContext, List<NewFeed> newsFeedsList) {
    ...
    public NewViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.course_content_layout, parent, false);
    ...
    public void onBindViewHolder(NewViewHolder holder, int position) {
        ...
        holder.itemView.setTag(holder.contentLink);
    }
    ...
    class NewViewHolder extends RecyclerView.ViewHolder {
        ...
        public NewViewHolder(View itemView) {
            super(itemView);
            cntLabel = itemView.findViewById(R.id.courseContentLayout_cntLabel);
        }
        ...
        void bind(final int position) {
            ...
            final String vLink = Uri.parse(newfeed.getContentLink()).getQueryParameter("v");

            contentLink = vLink;

            if (mOnItemClickListener != null && !cntLabel.callOnClick())
            {
                cntLabel.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        mOnItemClickListener.onItemClick(position, NewViewHolder.this);
                    }
                });
            }
        }
