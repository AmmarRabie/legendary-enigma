...
public class editcourseListMod extends RecyclerView.Adapter<editcourseListMod.courseListViewHolder> {
    ...
    public editcourseListMod(Context mContext, List<CourseLabel> courseList) {
