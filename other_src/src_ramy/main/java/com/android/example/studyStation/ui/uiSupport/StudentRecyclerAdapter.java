...
public class StudentRecyclerAdapter extends RecyclerView.Adapter<StudentRecyclerAdapter.StudentViewHolder>{
    ...
    private StudentRecyclerAdapter.OnItemClickListener mOnItemClickListener = null;
   // private LayoutInflater layout;
    ...
    public void setOnItemClickListener(StudentRecyclerAdapter.OnItemClickListener listener)
    {
