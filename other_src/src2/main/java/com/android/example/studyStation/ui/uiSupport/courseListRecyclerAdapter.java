...
public class courseListRecyclerAdapter extends RecyclerView.Adapter<courseListRecyclerAdapter.courseListViewHolder> {
    ...
    public void setOnItemClickListener(courseListRecyclerAdapter.OnItemClickListener listener)
    {
            ...
            if (mOnItemClickListener != null && !itemView.callOnClick()) {
                ...
                this.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        mOnItemClickListener.onItemClick(position,courseListRecyclerAdapter.courseListViewHolder.this);
                    }
                });
            }
        }
